...
async function main() {
    ...
    constants_1.DEFAULT_QUEUE_PERSISTENCE_ARRAY[0].locationPath = path_1.join(location, constants_1.DEFAULT_QUEUE_PERSISTENCE_PATH);
    const queueConfig = new QueueConfiguration_1.default(env.queueHost(), env.queuePort(), path_1.join(location, constants_1.DEFAULT_QUEUE_LOKI_DB_PATH), path_1.join(location, constants_1.DEFAULT_QUEUE_EXTENT_LOKI_DB_PATH), constants_1.DEFAULT_QUEUE_PERSISTENCE_ARRAY, !env.silent(), undefined, env.debug() !== undefined, await env.debug(), env.loose(), env.skipApiVersionCheck(), env.cert(), env.key(), env.pwd(), env.oauth(), env.disableProductStyleUrl());
    const tableConfig = new TableConfiguration_1.default(env.tableHost(), env.tablePort(), path_1.join(location, constants_2.DEFAULT_TABLE_LOKI_DB_PATH), env.debug() !== undefined, !env.silent(), undefined, await env.debug(), env.loose(), env.skipApiVersionCheck(), env.cert(), env.key(), env.pwd(), env.oauth(), env.disableProductStyleUrl());
