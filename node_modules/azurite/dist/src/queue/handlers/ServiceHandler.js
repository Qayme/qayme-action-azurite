...
class ServiceHandler extends BaseHandler_1.default {
    ...
    async setProperties(storageServiceProperties, options, context) {
        ...
        await this.metadataStore.updateServiceProperties(Object.assign(Object.assign({}, storageServiceProperties), { accountName }));
        const response = {
    ...
    async getProperties(options, context) {
        ...
        const response = Object.assign(Object.assign({}, properties), { requestId: context.contextID, statusCode: 200, version: constants_1.QUEUE_API_VERSION, clientRequestId: options.requestId });
        return response;
    }
