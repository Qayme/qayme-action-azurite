...
class MessageIdHandler extends BaseHandler_1.default {
    ...
    async update(queueMessage, popReceipt, visibilitytimeout, options, context) {
        ...
        if (queueMessage.messageText !== undefined &&
            utils_1.getUTF8ByteSize(queueMessage.messageText) > constants_1.MESSAGETEXT_LENGTH_MAX) {
            throw StorageErrorFactory_1.default.getRequestBodyTooLarge(queueCtx.contextID, {
                MaxLimit: "65536"
            });
        }
        const newPopReceipt = utils_1.getPopReceipt(context.startTime);
        // Validate the query parameters.
        const timeNextVisible = new Date(context.startTime.getTime() + constants_1.DEFUALT_UPDATE_VISIBILITYTIMEOUT * 1000 // 30s as default
        );
