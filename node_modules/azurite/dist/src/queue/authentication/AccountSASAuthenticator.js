...
class AccountSASAuthenticator {
    ...
    async validate(req, context) {
        ...
        const [sig1, stringToSign1] = IAccountSASSignatureValues_1.generateAccountSASSignature(values, account, accountProperties.key1);
        ...
        if (!sig1Pass) {
            ...
            const [sig2, stringToSign2] = IAccountSASSignatureValues_1.generateAccountSASSignature(values, account, accountProperties.key2);
