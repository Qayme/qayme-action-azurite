...
class QueueSASAuthenticator {
    ...
    async validate(req, context) {
        ...
        const [sig1, stringToSign1] = IQueueSASSignatureValues_1.generateQueueSASSignature(values, account, accountProperties.key1);
        ...
        if (!sig1Pass) {
            ...
            const [sig2, stringToSign2] = IQueueSASSignatureValues_1.generateQueueSASSignature(values, account, accountProperties.key2);
