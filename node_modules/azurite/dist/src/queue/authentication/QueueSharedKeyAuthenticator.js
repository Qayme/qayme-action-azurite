...
class QueueSharedKeyAuthenticator {
    ...
    async validate(req, context) {
        ...
        if (accountProperties === undefined) {
            ...
            throw StorageErrorFactory_1.default.getInvalidOperation(queueContext.contextID, "Invalid storage account.");
        }
        ...
        if (context.context.isSecondary && ((_a = queueContext.authenticationPath) === null || _a === void 0 ? void 0 : _a.indexOf(account)) === 1) {
            ...
            const stringToSign_secondary = headersToSign +
                ...
                (_b = queueContext.authenticationPath) === null || _b === void 0 ? void 0 : _b.replace(account, account + "-secondary"));
            ...
            if (type === "SharedKey") {
                ...
                for (const key in queries) {
                    if (queries.hasOwnProperty(key) && key.toLowerCase() === "comp") {
                        canonicalizedResourceString += `?comp=${decodeURIComponent(queries[key])}`;
                    }
                }
            }
        }
