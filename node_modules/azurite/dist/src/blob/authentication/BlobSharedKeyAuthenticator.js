...
class BlobSharedKeyAuthenticator {
    ...
    async validate(req, context) {
        ...
        if (accountProperties === undefined) {
            ...
            throw StorageErrorFactory_1.default.getInvalidOperation(blobContext.contextId, "Invalid storage account.");
        }
        const stringToSign = [
        ...
        if (context.context.isSecondary && ((_a = blobContext.authenticationPath) === null || _a === void 0 ? void 0 : _a.indexOf(account)) === 1) {
            ...
            const stringToSign_secondary = [
                ...
                (_b = blobContext.authenticationPath) === null || _b === void 0 ? void 0 : _b.replace(account, account + "-secondary"));
