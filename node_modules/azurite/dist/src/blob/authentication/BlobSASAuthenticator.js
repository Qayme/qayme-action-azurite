...
class BlobSASAuthenticator {
    ...
    async validate(req, context) {
        ...
        if (accountProperties === undefined) {
            throw StorageErrorFactory_1.default.getInvalidOperation(context.contextId, "Invalid storage account.");
        }
        ...
        const [sig1, stringToSign1] = IBlobSASSignatureValues_1.generateBlobSASSignature(values, resource, account, accountProperties.key1);
        ...
        if (accountProperties.key2 !== undefined) {
            ...
            const [sig2, stringToSign2] = IBlobSASSignatureValues_1.generateBlobSASSignature(values, resource, account, accountProperties.key2);
