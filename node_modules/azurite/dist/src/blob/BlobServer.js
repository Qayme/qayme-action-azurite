...
const LokiBlobMetadataStore_1 = tslib_1.__importDefault(require("./persistence/LokiBlobMetadataStore"));
 ...
 * @class Server
 */
class BlobServer extends ServerBase_1.default {
    /**
    ...
    constructor(configuration) {
        if (configuration === undefined) {
            configuration = new BlobConfiguration_1.default();
        }
        ...
        const metadataStore = new LokiBlobMetadataStore_1.default(configuration.metadataDBPath
        // logger
        );
        const extentMetadataStore = new LokiExtentMetadataStore_1.default(configuration.extentDBPath);
        const extentStore = new FSExtentStore_1.default(extentMetadataStore, configuration.persistencePathArray, Logger_1.default);
        ...
        const gcManager = new BlobGCManager_1.default(metadataStore, extentMetadataStore, extentStore, () => {
...
exports.default = BlobServer;
//# sourceMappingURL=BlobServer.js.map