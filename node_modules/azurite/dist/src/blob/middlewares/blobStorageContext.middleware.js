...
exports.extractStoragePartsFromPath = exports.blobStorageContextMiddleware = void 0;
...
function blobStorageContextMiddleware(req, res, next, skipApiVersionCheck, disableProductStyleUrl, loose) {
    ...
    if (!skipApiVersionCheck) {
        ...
        if (apiVersion !== undefined) {
            utils_1.checkApiVersion(apiVersion, constants_3.ValidAPIVersions, requestID);
        }
    }
    ...
    if (container && !container.startsWith("$")) {
        utils_1.validateContainerName(requestID, container);
    }
