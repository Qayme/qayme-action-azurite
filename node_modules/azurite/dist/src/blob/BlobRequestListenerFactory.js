...
class BlobRequestListenerFactory {
    ...
    createRequestListener() {
        ...
        const handlers = {
            ...
            containerHandler: new ContainerHandler_1.default(this.metadataStore, this.extentStore, Logger_1.default, loose),
            ...
            serviceHandler: new ServiceHandler_1.default(this.metadataStore, this.extentStore, Logger_1.default, loose),
            directoryHandler: {}
        };
        ...
        app.use(blobStorageContext_middleware_1.default(this.skipApiVersionCheck, this.disableProductStyleUrl, this.loose));
