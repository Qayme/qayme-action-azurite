...
class PageBlobHandler extends BaseHandler_1.default {
    ...
    async uploadPages(body, contentLength, options, context) {
        ...
        let ranges;
        try {
            ranges = utils_2.deserializePageBlobRangeHeader(blobCtx.request.getHeader("range"), blobCtx.request.getHeader("x-ms-range"), true);
        }
        catch (err) {
    ...
    async getPageRanges(options, context) {
        ...
        let ranges = utils_2.deserializePageBlobRangeHeader(blobCtx.request.getHeader("range"), blobCtx.request.getHeader("x-ms-range"), false);
        if (!ranges) {
    ...
    async getPageRangesDiff(prevsnapshot, options, context) {
        throw new NotImplementedError_1.default(context.contextId);
    }
