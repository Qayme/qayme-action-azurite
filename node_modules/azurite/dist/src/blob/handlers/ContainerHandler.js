...
class ContainerHandler extends BaseHandler_1.default {
    ...
    async getProperties(options, context) {
        ...
        const response = Object.assign(Object.assign({ statusCode: 200, requestId: context.contextId, clientRequestId: options.requestId, eTag: containerProperties.properties.etag }, containerProperties.properties), { blobPublicAccess: containerProperties.properties.publicAccess, metadata: containerProperties.metadata, version: constants_1.BLOB_API_VERSION });
        return response;
    }
    /**
        ...
        const response = {
            ...
            segment: {
                blobItems: blobs.map(item => {
                    return Object.assign(Object.assign({}, item), { deleted: item.deleted !== true ? undefined : true, snapshot: item.snapshot || undefined, properties: Object.assign(Object.assign({}, item.properties), { etag: utils_2.removeQuotationFromListBlobEtag(item.properties.etag), accessTierInferred: item.properties.accessTierInferred === true ? true : undefined }) });
                })
            },
            clientRequestId: options.requestId,
