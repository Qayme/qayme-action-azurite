...
class BlockBlobHandler extends BaseHandler_1.default {
    async upload(body, contentLength, options, context) {
        ...
        const blob = {
            ...
            metadata: utils_1.convertRawHeadersToMetadata(blobCtx.request.getRawHeaders()),
            accountName,
            containerName,
            name: blobName,
            properties: {
    ...
    async commitBlockList(blocks, options, context) {
        ...
        const parsed = await xml_1.parseXML(rawBody, true);
        ...
        blob.metadata = utils_1.convertRawHeadersToMetadata(
        // Preserve metadata key case
        ...
        const contentMD5 = await utils_2.getMD5FromString(rawBody);
        const response = {
            statusCode: 201,
