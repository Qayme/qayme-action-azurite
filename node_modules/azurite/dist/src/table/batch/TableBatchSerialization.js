...
exports.TableBatchSerialization = void 0;
const tslib_1 = require("tslib");
// import BatchOperation from "../../common/BatchOperation";
// import { BatchOperationType } from "../../common/BatchOperation";
const BatchOperation_1 = require("../../common/batch/BatchOperation");
const BatchSerialization_1 = require("../../common/batch/BatchSerialization");
const TableBatchOperation_1 = tslib_1.__importDefault(require("../batch/TableBatchOperation"));
const TableBatchUtils_1 = tslib_1.__importDefault(require("./TableBatchUtils"));
 ...
 */
class TableBatchSerialization extends BatchSerialization_1.BatchSerialization {
    /**
     ...
     */
    deserializeBatchRequest(batchRequestsString) {
        ...
        const batchOperations = subRequests.map((subRequest) => {
            ...
            if (subRequests.length > 1 &&
                ...
                throw new Error(`Couldn't extract path from sub-Request:\n ${subRequest}`);
            }
            let headers;
            let jsonBody;
            let subStringStart;
            ...
            const operation = new TableBatchOperation_1.default(BatchOperation_1.BatchType.table, headers);
            if (null !== requestType) {
                operation.httpMethod = requestType[0];
            }
     ...
     * @memberof TableBatchSerialization
     */
    serializeTablMergeEntityBatchResponse(request, response) {
        let serializedResponses = "";
        serializedResponses = this.SetContentTypeAndEncoding(serializedResponses);
        serializedResponses = this.serializeHttpStatusCode(serializedResponses, response.statusCode);
        serializedResponses = this.SerializeNoSniffNoCache(serializedResponses);
    ...
    async serializeTableQueryEntityWithPartitionAndRowKeyBatchResponse(request, response) {
        ...
        serializedResponses += (_a = request.params.queryOptions) === null || _a === void 0 ? void 0 : _a.format;
     ...
     * @memberof TableBatchSerialization
     */
    serializeDataServiceVersion(serializedResponses, request) {
    ...
    serializeError(err, contentID, request) {
        ...
        errorReponse +=
            ((_a = odataError.body) === null || _a === void 0 ? void 0 : _a.replace('"value":"', `\"value\":\"${contentID - 1}:`)) +
                "\r\n";
        return errorReponse;
    }
    /**
    ...
    serializeGeneralRequestError(odataErrorString, requestId) {
        ...
        const date = utils_1.truncatedISO8061Date(new Date(), true);
