...
class ExpressMiddlewareFactory extends MiddlewareFactory_1.default {
    ...
    createDispatchMiddleware() {
        return (req, res, next) => {
            ...
            dispatch_middleware_1.default(new Context_1.default(res.locals, this.contextPath, request, response), request, next, this.logger);
        };
    }
    /**
    ...
    createDeserializerMiddleware() {
        return (req, res, next) => {
            const request = new ExpressRequestAdapter_1.default(req);
            const response = new ExpressResponseAdapter_1.default(res);
            deserializer_middleware_1.default(new Context_1.default(res.locals, this.contextPath, request, response), request, next, this.logger);
        };
    }
    /**
    ...
    createSerializerMiddleware() {
        return (req, res, next) => {
            const request = new ExpressRequestAdapter_1.default(req);
            const response = new ExpressResponseAdapter_1.default(res);
            serializer_middleware_1.default(new Context_1.default(res.locals, this.contextPath, request, response), new ExpressResponseAdapter_1.default(res), next, this.logger);
        };
    }
    /**
    ...
    createErrorMiddleware() {
        return (err, req, res, next) => {
            const request = new ExpressRequestAdapter_1.default(req);
            const response = new ExpressResponseAdapter_1.default(res);
            error_middleware_1.default(new Context_1.default(res.locals, this.contextPath, request, response), err, new ExpressRequestAdapter_1.default(req), new ExpressResponseAdapter_1.default(res), next, this.logger);
        };
    }
    /**
    ...
    createEndMiddleware() {
        return (req, res) => {
            const request = new ExpressRequestAdapter_1.default(req);
            const response = new ExpressResponseAdapter_1.default(res);
            end_middleware_1.default(new Context_1.default(res.locals, this.contextPath, request, response), new ExpressResponseAdapter_1.default(res), this.logger);
        };
    }
}
