...
function getPayloadFormat(context) {
    var _a, _b;
    let format = (_a = context.request) === null || _a === void 0 ? void 0 : _a.getHeader(constants_1.HeaderConstants.ACCEPT);
    const formatParameter = (_b = context.request) === null || _b === void 0 ? void 0 : _b.getQuery("$format");
 ...
 * @return {*}  {boolean}
 */
function checkEtagIsInvalidFormat(etag) {
...
exports.checkEtagIsInvalidFormat = checkEtagIsInvalidFormat;
/**
