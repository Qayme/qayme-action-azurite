...
function tableStorageContextMiddleware(req, res, next, skipApiVersionCheck, disableProductStyleUrl) {
    ...
    if (!skipApiVersionCheck) {
        ...
        if (apiVersion !== undefined) {
            utils_1.checkApiVersion(apiVersion, constants_3.ValidAPIVersions, tableContext);
        }
    }
    ...
    if (tableSection === undefined || tableSection === "") {
        ...
        tableContext.partitionKey = tableSection.substring(firstQuoteIndex + 1, secondQuoteIndex);
        tableContext.rowKey = tableSection.substring(thridQuoteIndex + 1, fourthQuoteIndex);
    ...
    if (tableContext.tableName && !tableContext.tableName.startsWith("$")) {
        utils_1.validateTableName(tableContext, tableContext.tableName);
    }
