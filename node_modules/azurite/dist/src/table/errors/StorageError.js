...
class StorageError extends MiddlewareError_1.default {
    ...
    constructor(statusCode, storageErrorCode, storageErrorMessage, storageRequestID, storageAdditionalErrorMessages = {}, context) {
        const pyaload = utils_1.getPayloadFormat(context);
        const isJSON = pyaload === constants_1.NO_METADATA_ACCEPT ||
            pyaload === constants_1.MINIMAL_METADATA_ACCEPT ||
            pyaload === constants_1.FULL_METADATA_ACCEPT;
        ...
        const body = isJSON
            ...
            : xml_1.jsonToXML({ Error: bodyInJSON });
        ...
        }, body, isJSON ? `${pyaload};streaming=true;charset=utf-8` : "application/xml");
