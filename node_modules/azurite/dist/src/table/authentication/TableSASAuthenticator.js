...
class TableSASAuthenticator {
    ...
    async validate(req, context) {
        ...
        const [sig1, stringToSign1] = ITableSASSignatureValues_1.generateTableSASSignature(values, account, accountProperties.key1);
        ...
        if (accountProperties.key2 !== undefined) {
            ...
            const [sig2, stringToSign2] = ITableSASSignatureValues_1.generateTableSASSignature(values, account, accountProperties.key2);
