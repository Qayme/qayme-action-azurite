...
function activate(context) {
    ...
    context.subscriptions.push(vscode_1.commands.registerCommand("azurite.start", () => {
    ...
    }), vscode_1.commands.registerCommand(blobServerManager.getStartCommand(), () => {
        blobServerManager.start();
        ...
        blobServerManager.clean();
    }), vscode_1.commands.registerCommand(queueServerManager.getStartCommand(), () => {
        queueServerManager.start();
        ...
        queueServerManager.clean();
    }), vscode_1.commands.registerCommand(tableServerManager.getStartCommand(), () => {
        tableServerManager.start();
