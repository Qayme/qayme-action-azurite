...
class VSCServerManagerTable extends VSCServerManagerBase_1.default {
    ...
    async getConfiguration() {
        ...
        const config = new TableConfiguration_1.default(env.tableHost(), env.tablePort(), path_1.join(location, constants_1.DEFAULT_TABLE_LOKI_DB_PATH), (await env.debug()) === true, !env.silent(), this.accessChannelStream, undefined, env.loose(), env.skipApiVersionCheck(), env.cert(), env.key(), env.pwd(), env.oauth(), env.disableProductStyleUrl());
        return config;
    }
}
