...
async function run() {
    try {
        ...
        await exec.exec(`docker run -d --name ${containerName} -p 10000:10000 -p 10001:10001 -p 10002:10002 --name azurite ${fullImageName} azurite --blobHost 0.0.0.0 --tableHost 0.0.0.0 --queueHost 0.0.0.0`);
